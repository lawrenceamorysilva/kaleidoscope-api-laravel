<?php
     ...
     class ShippingController extends Controller
     {
         public function getShippingCost(Request $request)
         {
             ...
             if (!$suburbExists) {
                 return response()->json(['error' => "No price found for postcode $postcode, suburb $suburb, and weight $weight kg"], 404);
             }
             ...
             if (empty($costs)) {
                 return response()->json(['error' => "No shipping costs found for postcode $postcode, suburb $suburb, and weight $weight kg"], 404);
             }
